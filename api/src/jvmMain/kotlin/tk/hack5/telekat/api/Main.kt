...
fun main() = runBlocking {
    ...
    //client.sendMessage((dialogs.filter { (it as? DialogChat)?.peer?.fullName?.contains("instale") == true }.first() as DialogChat).peer, "hello from my new kotlin mtproto library")
    client.disconnect()
    Unit
}