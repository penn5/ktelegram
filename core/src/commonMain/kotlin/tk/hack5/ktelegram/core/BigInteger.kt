...
fun BigInteger.asTlObject128(): Int128Object = Int128Object(this, true)

fun BigInteger.asTlObject256(): Int256Object = Int256Object(this, true)

class Int128Object(private val int128: BigInteger, override val bare: Boolean) : TLObject<BigInteger> {
    init {
    ...
    override fun _toTlRepr(): IntArray {
        ...
        return ByteArray(16) { int128.shr(it * Byte.SIZE_BITS)
            .and(bigByteMask).toByte() }.toIntArray()
    }
    ...
    companion object : TLConstructor<Int128Object> {
        @ExperimentalUnsignedTypes
        ...
        override fun _fromTlRepr(data: IntArray): Pair<Int, Int128Object>? {
            if (data.size < 4)
                return null
            return Pair(4, Int128Object(BigInteger(data.sliceArray(0 until 4).toByteArray().reversedArray()), true))
        }
    }

}

class Int256Object(private val int256: BigInteger, override val bare: Boolean) : TLObject<BigInteger> {
    init {
    ...
    override fun _toTlRepr(): IntArray {
        val bigByteMask = BigInteger.of(0xFF)
        return ByteArray(32) { int256.shr(it * Byte.SIZE_BITS)
            .and(bigByteMask).toByte() }.toIntArray()
    }
    ...
    companion object : TLConstructor<Int128Object> {
        ...
        override fun _fromTlRepr(data: IntArray): Pair<Int, Int128Object>? {
            if (data.size < 8)
                return null
            return Pair(8, Int128Object(BigInteger(data.sliceArray(0 until 4).toByteArray().reversedArray()), true))
        }
    }
}
